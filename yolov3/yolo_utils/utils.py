...
def strip_optimizer(f='weights/last.pt'):  # from yolo_utils.yolo_utils import *; strip_optimizer()
...
def create_backbone(f='weights/last.pt'):  # from yolo_utils.yolo_utils import *; create_backbone()
...
def select_best_evolve(path='evolve*.txt'):  # from yolo_utils.yolo_utils import *; select_best_evolve()
...
def kmeans_targets(path='../coco/trainvalno5k.txt', n=9, img_size=416):  # from yolo_utils.yolo_utils import *; kmeans_targets()
...
def print_mutation(hyp, results, bucket=''):
    # Print mutation results to evolve.txt (for use with yolo_model.py --evolve)
...
def plot_results(start=0, stop=0):  # from yolo_utils.yolo_utils import *; plot_results()
